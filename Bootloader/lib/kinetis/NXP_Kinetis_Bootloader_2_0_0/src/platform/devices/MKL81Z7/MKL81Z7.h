...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MKL81Z7
**
 ...
 * @version 1.5
 * @date 2015-09-24
 * @brief CMSIS Peripheral Access Layer for MKL81Z7
 *
 * CMSIS Peripheral Access Layer for MKL81Z7
 */

#ifndef _MKL81Z7_H_
#define _MKL81Z7_H_                              /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  Tamper_IRQn                  = 16,               /**< DryIce tamper detect */
...
#include "system_MKL81Z7.h"            /* Device specific configuration file */
...
#define DRY_CR_ATCS_MASK                         (0x30U)
#define DRY_CR_ATCS_SHIFT                        (4U)
#define DRY_CR_ATCS(x)                           (((uint32_t)(((uint32_t)(x)) << DRY_CR_ATCS_SHIFT)) & DRY_CR_ATCS_MASK)
...
#define DRY_CR_SRF_MASK                          (0xC000U)
#define DRY_CR_SRF_SHIFT                         (14U)
#define DRY_CR_SRF(x)                            (((uint32_t)(((uint32_t)(x)) << DRY_CR_SRF_SHIFT)) & DRY_CR_SRF_MASK)
...
#define DRY_PGFR_TPSW_MASK                       (0x300U)
#define DRY_PGFR_TPSW_SHIFT                      (8U)
#define DRY_PGFR_TPSW(x)                         (((uint32_t)(((uint32_t)(x)) << DRY_PGFR_TPSW_SHIFT)) & DRY_PGFR_TPSW_MASK)
#define DRY_PGFR_TPSF_MASK                       (0xC00U)
#define DRY_PGFR_TPSF_SHIFT                      (10U)
#define DRY_PGFR_TPSF(x)                         (((uint32_t)(((uint32_t)(x)) << DRY_PGFR_TPSF_SHIFT)) & DRY_PGFR_TPSF_MASK)
...
#define DRY_PGFR_TPS_MASK                        (0x2000000U)
#define DRY_PGFR_TPS_SHIFT                       (25U)
#define DRY_PGFR_TPS(x)                          (((uint32_t)(((uint32_t)(x)) << DRY_PGFR_TPS_SHIFT)) & DRY_PGFR_TPS_MASK)

/* The count of DRY_PGFR */
#define DRY_PGFR_COUNT                           (8U)
...
/** Array initializer of DRY peripheral base addresses */
#define DRY_BASE_ADDRS                           { DRY_BASE }
/** Array initializer of DRY peripheral base pointers */
#define DRY_BASE_PTRS                            { DRY }
/** Interrupt vectors for the DRY peripheral type */
#define DRY_IRQS                                 { Tamper_IRQn }
...
#define RCM_SSRS1_STAMPER_MASK                   (0x80U)
#define RCM_SSRS1_STAMPER_SHIFT                  (7U)
#define RCM_SSRS1_STAMPER(x)                     (((uint8_t)(((uint8_t)(x)) << RCM_SSRS1_STAMPER_SHIFT)) & RCM_SSRS1_STAMPER_MASK)
...
#define RTC_TTR_TDTL_MASK                        (0x1F000U)
#define RTC_TTR_TDTL_SHIFT                       (12U)
#define RTC_TTR_TDTL(x)                          (((uint32_t)(((uint32_t)(x)) << RTC_TTR_TDTL_SHIFT)) & RTC_TTR_TDTL_MASK)
#define RTC_TTR_TDTH_MASK                        (0x3E0000U)
#define RTC_TTR_TDTH_SHIFT                       (17U)
