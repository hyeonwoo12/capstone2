...
EOBJS           := $(addprefix $(BUILD_DIR)/, $(patsubst %.S,%.o,$(ECDSA)))
SUBDIRS		:= $(sort $(addprefix $(BUILD_DIR)/, $(dir $(ASRCS))) $(addprefix $(BUILD_DIR)/, $(dir $(SRCS))) $(addprefix $(BUILD_DIR)/, $(dir $(ECDSA))) )
OBJS		:= $(COBJS) $(AOBJS) $(EOBJS)
DEPS		:= $(COBJS:.o=.d)
